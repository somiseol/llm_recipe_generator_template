...
// configure app to use the Handlebars template engine and 
...
// Handle application errors by logging the error details
// to the console, and showing the user a web page with 
